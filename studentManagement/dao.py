...
## Quản lý lớp học
# lấy danh sách lớp
def load_class_by_period(grade=None, page=None, class_name=None, class_id=None, period=None):
    query = Class.query
...
def count_students_of_classes_by_subject_and_period(subject_id, semester, year, avg_gt_or_equal_to=None):
    ...
    #Truy vấn số lượng học sinh theo lớp
    base_query = (
    ...
    #Truy vấn số lượng học sinh theo lớp có điểm trung bình >= 5 nếu có truyền số điểm
